...
public class BluetoothChatService {
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(MainRemote.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(MainRemote.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(MainRemote.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(MainRemote.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(MainRemote.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
